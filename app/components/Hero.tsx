    ...
    <section className="min-h-screen bg-linear-to-b from-blue-950 via-zinc-950 to-blue-950 text-white flex items-center">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          >
            PC & Laptop Repair
            <span className="text-blue-500 drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]"> At Your Doorstep</span>
          </motion.h1>
          ...
          <div className="flex gap-4 mt-8">
            <a
              ...
              target="_blank"
              className="bg-blue-500 hover:bg-blue-400 shadow-[0_0_25px_rgba(59,130,246,0.5)] text-white px-6 py-3 rounded-xl font-semibold transition-all"
            >
              Contact Us
            </a>
